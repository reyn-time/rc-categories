...
var file_proto_auth_v1_auth_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		ExtendedType:  (*descriptorpb.MethodOptions)(nil),
		ExtensionType: (*bool)(nil),
		Field:         50000,
		Name:          "auth.v1.auth_enabled",
		Tag:           "varint,50000,opt,name=auth_enabled",
		Filename:      "proto/auth/v1/auth.proto",
	},
}

// Extension fields to descriptorpb.MethodOptions.
var (
	// optional bool auth_enabled = 50000;
	E_AuthEnabled = &file_proto_auth_v1_auth_proto_extTypes[0]
)
...
var file_proto_auth_v1_auth_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3a, 0x46, 0x0a, 0x0c, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x65, 0x6e,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0xd0, 0x86, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x61,
	0x75, 0x74, 0x68, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x88, 0x01, 0x01, 0x42, 0x9a, 0x01,
	0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x42, 0x09, 0x41,
	0x75, 0x74, 0x68, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x43, 0x67, 0x69, 0x74, 0x68,
...
var file_proto_auth_v1_auth_proto_depIdxs = []int32{
	0, // 0: auth.v1.auth_enabled:extendee -> google.protobuf.MethodOptions
...
func file_proto_auth_v1_auth_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		ExtensionInfos:    file_proto_auth_v1_auth_proto_extTypes,
	}.Build()
